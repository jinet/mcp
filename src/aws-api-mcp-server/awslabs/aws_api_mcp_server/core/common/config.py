...
ALLOW_UNRESTRICTED_FILE_ACCESS_KEY = 'AWS_API_MCP_ALLOW_UNRESTRICTED_FILE_ACCESS'
...
ALLOW_UNRESTRICTED_FILE_ACCESS = get_env_bool(ALLOW_UNRESTRICTED_FILE_ACCESS_KEY, False)
